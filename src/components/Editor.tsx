...
export const Editor: React.FC<EditorProps> = ({ subredditId }) => {
  ...
  return (
<div className={`w-full p-4 ${bgColor} rounded-lg border ${borderColor}`}>
      <form
      ...
      >
        <div className='prose prose-stone dark:prose-invert'>
          <TextareaAutosize
            ...
            {...rest}
            placeholder='Title'
            className={`w-full resize-none appearance-none overflow-hidden bg-transparent text-5xl font-bold focus:outline-none ${textColor}`}
          />
        <div
            id='editor'
            className={`min-h-[500px] ${menuBgColor} ${menuTextColor}`}
          />
